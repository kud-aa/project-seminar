...
VALUES
  ...
  (13,"et malesuada",13),
  (14,"lorem, sit",14),
  (15,"Mauris blandit",15),
  (16,"in molestie",16),
  (17,"lorem, sit",17),
  (18,"Vestibulum ante",18),
  (19,"adipiscing, enim",19),
  (20,"vitae odio",20);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (21,"in, cursus",21),
  ...
  (24,"eu dui.",24),
  (25,"nisi. Mauris",25),
  (26,"hendrerit neque.",26),
  (27,"sed, facilisis",27),
  (28,"tincidunt nibh.",28),
  (29,"lobortis mauris.",29),
  (30,"faucibus leo,",30);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (31,"scelerisque, lorem",31),
  (32,"Suspendisse commodo",32),
  (33,"nisi a",33),
  (34,"enim. Etiam",34),
  (35,"risus. Duis",35),
  (36,"facilisis, magna",36),
  (37,"eget varius",37),
  (38,"in felis.",38),
  (39,"lacus. Quisque",39),
  (40,"congue a,",40);
...
VALUES
  ...
  (48,"sit amet",48),
  (49,"urna, nec",49),
  (50,"blandit mattis.",50);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (51,"Sed molestie.",51),
  (52,"sem egestas",52),
  (53,"nunc risus",53),
  (54,"Aliquam adipiscing",54),
  (55,"Aliquam gravida",55),
  (56,"In at",56),
  (57,"eu neque",57),
  (58,"vel, vulputate",58),
  (59,"purus. Maecenas",59),
  (60,"placerat, augue.",60);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (61,"Mauris non",61),
  (62,"at auctor",62),
  (63,"Donec elementum,",63),
  (64,"enim. Nunc",64),
  (65,"varius ultrices,",65),
  (66,"Donec non",66),
  (67,"eu enim.",67),
  (68,"velit egestas",68),
  (69,"Duis dignissim",69),
  (70,"Maecenas malesuada",70);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (71,"est tempor",71),
  (72,"orci luctus",72),
  ...
  (74,"a odio",74),
  (75,"nec enim.",75),
  (76,"conubia nostra,",76),
  (77,"porttitor scelerisque",77),
  (78,"Aenean euismod",78),
  (79,"mollis. Phasellus",79),
  (80,"eget odio.",80);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (81,"mollis nec,",81),
...
VALUES
  (91,"Proin eget",91),
  (92,"quis, tristique",92),
  (93,"lacus. Aliquam",93),
  (94,"turpis. In",94),
  (95,"interdum libero",95),
  (96,"vulputate, risus",96),
  (97,"lorem ac",97),
  (98,"Sed eu",98),
  (99,"Morbi sit",99),
  (100,"Nunc pulvinar",100);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (101,"ultrices. Duis",101),
  (102,"tellus non",102),
  (103,"dolor sit",103),
  (104,"Donec vitae",104),
  (105,"Donec sollicitudin",105),
  (106,"sagittis semper.",106),
  (107,"sagittis. Nullam",107),
  (108,"Duis elementum,",108),
  (109,"nascetur ridiculus",109),
  (110,"a, malesuada",110);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (111,"tortor, dictum",111),
  (112,"adipiscing lacus.",112),
  (113,"ac ipsum.",113),
  (114,"feugiat non,",114),
  (115,"porttitor eros",115),
  (116,"tellus. Aenean",116),
  (117,"ornare lectus",117),
  (118,"dignissim tempor",118),
  (119,"a, enim.",119),
  (120,"feugiat. Sed",120);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (121,"Nulla eget",121),
  (122,"Morbi non",122),
  (123,"scelerisque mollis.",123),
  (124,"pede, nonummy",124),
  (125,"venenatis vel,",125),
  (126,"risus quis",126),
  (127,"enim diam",127),
  (128,"Donec non",128),
  (129,"imperdiet ullamcorper.",129),
  (130,"vitae, aliquet",130);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (131,"aliquet vel,",131),
  (132,"massa rutrum",132),
  (133,"a, magna.",133),
  (134,"euismod enim.",134),
  (135,"eu nulla",135),
  (136,"massa. Mauris",136),
  (137,"pede et",137),
  (138,"et, rutrum",138),
  (139,"tortor nibh",139),
  (140,"tristique aliquet.",140);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (141,"dictum augue",141),
  (142,"Proin vel",142),
  (143,"malesuada vel,",143),
  (144,"cursus et,",144),
  (145,"at pede.",145),
  (146,"sodales. Mauris",146),
  (147,"aliquet, metus",147),
  (148,"dictum. Proin",148),
  (149,"Sed diam",149),
  (150,"nulla at",150);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (151,"Morbi metus.",151),
  (152,"posuere at,",152),
  (153,"pretium aliquet,",153),
  (154,"euismod enim.",154),
  (155,"non, lobortis",155),
  (156,"in, dolor.",156),
  (157,"enim, sit",157),
  (158,"pharetra nibh.",158),
  (159,"facilisis, magna",159),
  (160,"cursus et,",160);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (161,"convallis dolor.",161),
  (162,"Duis risus",162),
  (163,"ante ipsum",163),
  (164,"feugiat metus",164),
  (165,"mattis semper,",165),
  (166,"nibh sit",166),
  (167,"ornare tortor",167),
  (168,"auctor vitae,",168),
  (169,"gravida molestie",169),
  (170,"eu neque",170);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (171,"rutrum lorem",171),
  (172,"arcu. Sed",172),
  (173,"in magna.",173),
  (174,"ornare. In",174),
  (175,"scelerisque dui.",175),
  (176,"ipsum non",176),
  (177,"luctus felis",177),
  (178,"Quisque ac",178),
  (179,"ac mattis",179),
  (180,"Cras pellentesque.",180);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (181,"dis parturient",181),
  (182,"habitant morbi",182),
  (183,"Morbi vehicula.",183),
  (184,"facilisis. Suspendisse",184),
  (185,"hendrerit a,",185),
  (186,"nonummy ut,",186),
  (187,"sed, sapien.",187),
  (188,"augue porttitor",188),
  (189,"amet, consectetuer",189),
  (190,"purus. Maecenas",190);
INSERT INTO groups(id, group_name, faculty_id) 
VALUES
  (191,"sodales purus,",191),
  (192,"lacus. Aliquam",192),
  (193,"egestas. Aliquam",193),
  (194,"ac, fermentum",194),
  (195,"Morbi sit",195),
  (196,"Fusce diam",196),
  (197,"molestie tellus.",197),
  (198,"montes, nascetur",198),
...
VALUES
  ("Maggie","Stewart","618-8727",1,1),
  ("Ulric","Woods","1-517-781-2575",2,2),
  ("Avye","Allen","326-6654",3,3),
  ("Ezra","Hamilton","702-5283",4,4),
  ("Chaim","Rhodes","262-9036",5,5),
  ("Maya","Murphy","616-4717",6,6),
  ("Guy","Pate","566-3747",7,7),
  ("August","Peck","1-488-700-2208",8,8),
  ("Cooper","Yates","1-624-889-7209",9,9),
  ("Jocelyn","Potter","1-865-478-5328",10,10);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Dalton","Bright","1-302-344-6332",11,11),
  ("Paul","Neal","1-525-660-4043",12,12),
  ("Justin","Lindsay","115-2731",13,13),
  ("Lillian","Brooks","1-571-633-4617",14,14),
  ("Amal","Rios","1-447-598-4439",15,15),
  ("Medge","Hoffman","386-9601",16,16),
  ("Blaze","Mosley","341-8932",17,17),
  ("Dorothy","Terrell","1-217-483-6660",18,18),
  ("MacKensie","Whitley","238-8442",19,19),
  ("Brock","Barker","542-2234",20,20);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Gemma","Valdez","555-6435",21,21),
  ("Ori","Hoffman","564-2668",22,22),
  ("Brian","Mcdaniel","1-235-865-2361",23,23),
  ("Maisie","Stark","1-275-888-3225",24,24),
  ("Emery","Conrad","708-9837",25,25),
  ("Faith","Lynch","981-3504",26,26),
  ("Slade","Riddle","1-144-947-3696",27,27),
  ("Noel","Fields","836-3748",28,28),
  ("Owen","Oneil","938-4120",29,29),
  ("Ronan","Jenkins","487-2124",30,30);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Mira","Chan","1-290-475-1241",31,31),
  ("Hakeem","Cherry","1-788-388-7266",32,32),
  ("Ori","Middleton","314-3243",33,33),
  ("Reese","Church","1-728-845-2917",34,34),
  ("Aladdin","Thornton","517-1066",35,35),
  ("Fletcher","Kent","1-284-532-0388",36,36),
  ("Wang","Hill","1-207-373-9786",37,37),
  ("Shea","Dixon","315-1372",38,38),
  ("Fletcher","Bridges","728-1712",39,39),
  ("Iliana","Schwartz","203-2515",40,40);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Nathan","Allen","1-835-519-5586",41,41),
  ("Allistair","Madden","1-757-256-1675",42,42),
  ("Merrill","Robinson","1-811-751-9463",43,43),
  ("Marcia","Burnett","1-150-367-8718",44,44),
  ("Molly","Hodge","786-4716",45,45),
  ("Alexander","Craig","461-1183",46,46),
  ("Dale","Chase","426-6637",47,47),
  ("Maris","Hopper","583-6246",48,48),
  ("Peter","Mcdaniel","1-898-332-9224",49,49),
  ("Neve","Moses","311-6498",50,50);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Steel","Goodman","887-5586",51,51),
  ("Haley","Rivas","1-526-837-2767",52,52),
  ("Petra","Ward","1-267-555-5537",53,53),
  ("Selma","Sellers","309-7646",54,54),
  ("Xandra","Reyes","1-679-989-3546",55,55),
  ("Mikayla","Mills","1-494-729-7606",56,56),
  ("Grace","Soto","1-730-277-4312",57,57),
  ("Chloe","Ballard","419-0145",58,58),
  ("Denton","Ayala","518-0321",59,59),
  ("Julian","Chan","614-7751",60,60);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Caleb","Wyatt","1-175-635-4416",61,61),
  ("Nadine","Terrell","1-469-510-1761",62,62),
  ("Kyle","Lindsey","863-3118",63,63),
  ("Pandora","Mcknight","1-547-685-5759",64,64),
  ("Roth","Morris","1-563-231-8523",65,65),
  ("Clayton","Warren","1-213-416-2359",66,66),
  ("Peter","Salinas","1-222-666-5186",67,67),
  ("Jordan","Branch","1-371-631-1765",68,68),
  ("Basil","Melton","1-838-324-0161",69,69),
  ("Mariam","Bush","336-4342",70,70);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Blaze","Downs","1-259-551-5551",71,71),
  ("Breanna","Stephens","1-204-595-1436",72,72),
  ("Madeson","Ferguson","562-6135",73,73),
  ("Lara","Reyes","1-375-406-1156",74,74),
  ("Patricia","Rodriquez","573-4803",75,75),
  ("Avram","Crosby","1-685-588-5317",76,76),
  ("Sonya","Acosta","623-3181",77,77),
  ("Damon","White","1-702-257-0074",78,78),
  ("Christopher","Scott","1-778-826-6779",79,79),
  ("Kerry","Watts","767-5636",80,80);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Madaline","Mccall","1-916-464-6394",81,81),
  ("Buckminster","Hester","1-183-516-7432",82,82),
  ("Robin","Buck","876-7618",83,83),
  ("Kibo","Jones","597-2085",84,84),
  ("Evangeline","Morales","932-3474",85,85),
  ("Dexter","Chang","110-5976",86,86),
  ("Axel","Bates","1-254-151-1328",87,87),
  ("Ursa","English","1-746-392-8368",88,88),
  ("Jason","Sheppard","461-4231",89,89),
  ("Violet","Gibbs","1-326-672-7291",90,90);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Charity","Kent","542-3426",91,91),
  ("Deanna","Jordan","1-551-448-5460",92,92),
  ("Luke","Cox","1-726-958-7812",93,93),
  ("Dawn","Carpenter","938-3877",94,94),
  ("Olga","Bradford","575-6739",95,95),
  ("Denise","Foster","611-9652",96,96),
  ("Octavius","William","1-851-257-6355",97,97),
  ("Ila","Reynolds","660-4328",98,98),
  ("Lavinia","Cobb","1-368-773-7484",99,99),
  ("Ryan","Park","748-4046",100,100);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Zenia","Farley","524-3815",101,101),
  ("Abdul","Phillips","1-771-542-1244",102,102),
  ("Josiah","Snider","140-9846",103,103),
  ("Quamar","Church","1-368-673-9375",104,104),
  ("Lee","Mayer","1-558-474-4447",105,105),
  ("Karleigh","Ferguson","140-5385",106,106),
  ("Lewis","Pugh","1-292-754-1704",107,107),
  ("Tyler","Nelson","1-947-481-1458",108,108),
  ("Kevyn","Briggs","480-3278",109,109),
  ("Mara","Beach","378-4111",110,110);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Xavier","Klein","1-872-719-4042",111,111),
  ("Ian","Mercer","1-523-657-6925",112,112),
  ("David","Sexton","1-586-385-6027",113,113),
  ("Lacy","Lynch","325-2116",114,114),
  ("Tanek","Blevins","1-167-487-2435",115,115),
  ("Brianna","Norman","469-1762",116,116),
  ("Josephine","Hartman","1-666-862-6867",117,117),
  ("Sybil","Heath","1-514-253-0493",118,118),
  ("Austin","Ortiz","618-8718",119,119),
  ("Harper","Hancock","1-354-737-1127",120,120);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Sybil","Snider","672-3262",121,121),
  ("Levi","Hurley","877-5581",122,122),
  ("Colette","Ward","1-428-627-0902",123,123),
  ("Megan","Parks","544-0969",124,124),
  ("Myles","Harding","252-9425",125,125),
  ("Shafira","Mcmahon","236-5007",126,126),
  ("Hannah","Mcclain","1-469-738-5728",127,127),
  ("Graiden","Vega","1-465-248-2415",128,128),
  ("Wade","Ochoa","1-489-877-1051",129,129),
  ("Dillon","Moon","1-616-469-8623",130,130);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Adam","Suarez","224-0926",131,131),
  ("Vladimir","Conner","1-974-181-3736",132,132),
  ("Hamilton","Chandler","1-285-376-5666",133,133),
  ("Sade","Bradshaw","1-940-214-7477",134,134),
  ("Madonna","Vincent","1-717-333-3727",135,135),
  ("Celeste","Sweet","366-0103",136,136),
  ("Jasmine","Solomon","1-722-580-8868",137,137),
  ("Adam","Hill","847-1763",138,138),
  ("David","Prince","1-461-726-7026",139,139),
  ("Stella","Douglas","1-185-186-2586",140,140);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Edward","Dodson","1-403-487-6213",141,141),
  ("MacKensie","Conrad","1-317-849-8861",142,142),
  ("Alexandra","Murray","1-654-539-4779",143,143),
  ("Kevin","Shelton","1-836-302-5267",144,144),
  ("Naida","Wilkinson","1-996-886-4182",145,145),
  ("Octavius","Valenzuela","861-6667",146,146),
  ("Peter","Ayala","1-167-324-4244",147,147),
  ("Carol","Bartlett","974-5976",148,148),
  ("Sydnee","Price","464-5224",149,149),
  ("Geoffrey","Lucas","1-980-776-7423",150,150);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Fritz","Glover","1-584-268-5373",151,151),
  ("Portia","Espinoza","101-8354",152,152),
  ("Deacon","Grimes","570-7271",153,153),
  ("Harding","Hodges","1-752-436-4602",154,154),
  ("Sharon","Mendez","1-754-137-8616",155,155),
  ("Seth","Morales","1-352-624-1272",156,156),
  ("Wade","Cooley","1-739-876-9098",157,157),
  ("Drew","English","1-726-741-4143",158,158),
  ("Baxter","Cole","534-8142",159,159),
  ("Damian","Velez","764-9484",160,160);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Carly","Pugh","575-4619",161,161),
  ("Hillary","Harvey","1-883-370-7280",162,162),
  ("Idola","Hutchinson","683-6444",163,163),
  ("Kaseem","Compton","921-3306",164,164),
  ("Nehru","Ayers","833-8460",165,165),
  ("Tanisha","Acosta","655-1273",166,166),
  ("Ferdinand","Bryan","1-317-632-1264",167,167),
  ("Mollie","Davis","662-8364",168,168),
  ("Harrison","Little","448-1526",169,169),
  ("Kieran","Newton","583-5678",170,170);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Oliver","Bradford","531-6596",171,171),
  ("Ezekiel","Medina","1-811-510-4791",172,172),
  ("Jade","Vargas","838-5556",173,173),
  ("Wesley","Davidson","546-2264",174,174),
  ("Charles","Matthews","393-5876",175,175),
  ("Blythe","Noble","1-680-285-7273",176,176),
  ("Iona","Cook","266-8365",177,177),
  ("Quinlan","Wise","483-4631",178,178),
  ("Jerome","Joyce","156-2504",179,179),
  ("Delilah","Wilkins","461-4443",180,180);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Daria","Hess","535-0323",181,181),
  ("Shana","York","1-884-654-9735",182,182),
  ("Stewart","Bailey","811-3494",183,183),
  ("Laura","Riggs","241-2638",184,184),
  ("Devin","Fuller","594-3267",185,185),
  ("Linda","Chaney","1-397-756-8175",186,186),
  ("Ralph","Key","423-8525",187,187),
  ("Nola","Carpenter","1-797-208-3926",188,188),
  ("Clio","Mueller","1-544-235-5810",189,189),
  ("Zena","Whitley","837-1472",190,190);
INSERT INTO students(first_name, last_name, home_phone, faculty_id, group_id) 
VALUES
  ("Timothy","Huff","329-7167",191,191),
  ("Ira","Craft","1-540-384-5061",192,192),
  ("Thaddeus","Roth","1-505-257-3813",193,193),
  ("Wallace","Chambers","1-784-303-8135",194,194),
  ("Larissa","Buckley","764-3023",195,195),
  ("Whilemina","Thomas","557-3541",196,196),
  ("Bert","Donovan","1-331-774-0445",197,197),
  ("Hadassah","Keith","1-828-272-5862",198,198),
